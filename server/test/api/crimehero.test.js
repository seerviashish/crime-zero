...
describe('API TEST', () => {
  ...
  describe('GET /hero?code=0<space><code>', () => {
    it('Get /hero?code=0 8467 api call with x-client-id header should give json and response code 200.', () => {
      return request(server)
    ...
    it('Get /hero?code=0 8467 api call without x-client-id header should give response code 403.', () => {
      return request(server)
        .get('/hero?code=0 8467')
    ...
    it('Get /hero api call without x-client-id header should give response code 403.', () => {
      return request(server)
        .get('/hero')
        .expect('Content-Type', /json/)
        .expect(httpStatus.FORBIDDEN)
    ...
    it('Get /hero api call with x-client-id header should give json and response code 403.', () => {
      return request(server)
        .get('/hero')
        .set('x-client-id', 'crimehero123')
        .expect('Content-Type', /json/)
    ...
    it('Get /hero?code=0 80267 api call with not validated code and x-client-id header should give json and response code 403.', async () => {
      return request(server)
